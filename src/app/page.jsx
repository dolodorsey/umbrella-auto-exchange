...
const SVCS = [{n:"Collision Repair",d:"Vetted body shop network for collision, paint, and structural work."},{n:"Fleet Management",d:"Multi-vehicle coordination for corporate and personal fleets."},{n:"Auto Detailing",d:"Premium detailing — ceramic coating, paint correction, interior."},{n:"Dealer Network",d:"Trusted dealers for buying, selling, and trading vehicles."}];
  ...
  return (<>
    ...
    <section style={{position:'relative',height:'100vh',overflow:'hidden',display:'flex',flexDirection:'column',justifyContent:'center',background:'#14161B'}}>
      <div style={{position:'absolute',top:0,left:0,width:'100%',height:'100%',zIndex:0}}>
        <img src="https://dzlmtvodpyhetvektfuo.supabase.co/storage/v1/object/public/brand-graphics/dr_dorsey/website/penthouse-skyline.jpg" alt="" style={{position:'absolute',top:0,left:0,width:'100%',height:'100%',objectFit:'cover',opacity:0.35,animation:'slowZoom 20s ease-in-out infinite alternate'}} />
      ...
      <div style={{position:'relative',zIndex:4,maxWidth:620,padding:'0 clamp(20px,4vw,80px)'}}>
        <div style={{fontFamily:'DM Mono,monospace',fontSize:'clamp(8px,0.7vw,10px)',letterSpacing:'0.35em',textTransform:'uppercase',color:'#B4975A',marginBottom:20,animation:'fadeUp 0.8s cubic-bezier(0.16,1,0.3,1) 2.2s both'}}>Umbrella Auto Exchange × The Kollective</div>
        <h1 style={{fontFamily:'Cormorant Garamond,serif',fontSize:'clamp(36px,7vw,90px)',fontWeight:300,lineHeight:1.08,letterSpacing:'-0.02em',color:'#F7F7F4',margin:0,animation:'fadeUp 1s cubic-bezier(0.16,1,0.3,1) 2.4s both'}}>Full-service<br />auto solutions.<br />One <em style={{fontStyle:'italic',color:'#3B536B'}}>call.</em></h1>
        <p style={{fontSize:'clamp(13px,1.2vw,16px)',color:'rgba(247,247,244,0.45)',lineHeight:1.7,maxWidth:440,marginTop:24,animation:'fadeUp 0.8s cubic-bezier(0.16,1,0.3,1) 2.6s both'}}>Collision repair coordination, fleet management, luxury detailing, dealer connections, and insurance claims.</p>
    ...
    <section id="services" style={{position:'relative',padding:'clamp(80px,10vw,140px) clamp(20px,4vw,80px)',background:'#14161B'}}>
      <div style={{position:'absolute',top:0,left:0,width:'100%',height:'100%',zIndex:0}}>
        <img src="https://dzlmtvodpyhetvektfuo.supabase.co/storage/v1/object/public/brand-graphics/dr_dorsey/website/luxury-venue.jpg" alt="" style={{position:'absolute',top:0,left:0,width:'100%',height:'100%',objectFit:'cover',opacity:0.05,filter:'brightness(0.3)'}} />
      </div>
    ...
    <div style={{position:'relative',height:'clamp(280px,40vw,450px)',overflow:'hidden'}}>
      ...
      <div style={{position:'absolute',top:0,left:0,width:'100%',height:'100%',display:'flex',alignItems:'center',justifyContent:'flex-start',padding:'0 clamp(40px,6vw,120px)'}}>
        <div style={{fontFamily:'Cormorant Garamond,serif',fontSize:'clamp(22px,4vw,52px)',fontWeight:300,fontStyle:'italic',color:'#B4975A',maxWidth:550,lineHeight:1.3,textShadow:'0 2px 20px rgba(0,0,0,0.8)'}}>&ldquo;Vehicle Services & Auto Solutions — built different.&rdquo;</div>
      </div>
    </div>
    ...
    <section id="about" style={{position:'relative',padding:'clamp(80px,10vw,140px) clamp(20px,4vw,80px)',background:'#F7F7F4',color:'#14161B',overflow:'hidden'}}>
      ...
      <div style={{maxWidth:1400,margin:'0 auto',position:'relative',zIndex:1}}>
        <div ref={addR} style={{opacity:0,transform:'translateY(35px)',transition:'opacity 0.8s cubic-bezier(0.16,1,0.3,1),transform 0.8s cubic-bezier(0.16,1,0.3,1)'}}>
          ...
          <p style={{fontSize:'clamp(14px,1.3vw,18px)',color:'rgba(20,22,27,0.5)',lineHeight:1.8,maxWidth:600,marginBottom:40}}>Umbrella Auto Exchange operates under The Kollective Hospitality Group — a multi-brand enterprise spanning events, food & beverage, museums, consumer products, technology, and wellness across 8 cities.</p>
    ...
    <section id="connect" style={{position:'relative',padding:'clamp(80px,10vw,140px) clamp(20px,4vw,80px)',background:'#14161B',overflow:'hidden'}}>
      <div style={{position:'absolute',top:0,left:0,width:'100%',height:'100%'}}>
        <img src="https://dzlmtvodpyhetvektfuo.supabase.co/storage/v1/object/public/brand-graphics/dr_dorsey/website/penthouse-skyline.jpg" alt="" style={{position:'absolute',top:0,left:0,width:'100%',height:'100%',objectFit:'cover',opacity:0.08,filter:'brightness(0.2)'}} />
      </div>
      <div style={{maxWidth:900,margin:'0 auto',textAlign:'center',position:'relative',zIndex:1}}>
        <div ref={addR} style={{opacity:0,transform:'translateY(35px)',transition:'opacity 0.8s cubic-bezier(0.16,1,0.3,1),transform 0.8s cubic-bezier(0.16,1,0.3,1)'}}>
          ...
          <p style={{fontSize:'clamp(14px,1.3vw,18px)',color:'rgba(247,247,244,0.45)',lineHeight:1.7,maxWidth:560,margin:'0 auto 48px'}}>Collision repair coordination, fleet management, luxury detailing, dealer connections, and insurance claims.</p>
          <div style={{display:'flex',gap:20,justifyContent:'center',flexWrap:'wrap',marginBottom:56}}>
            <a href="mailto:thedoctordorsey@gmail.com?subject=Umbrella Auto Exchange Inquiry" style={{fontFamily:'DM Mono,monospace',fontSize:'clamp(8px,0.7vw,10px)',letterSpacing:'0.2em',textTransform:'uppercase',color:'#14161B',background:'#B4975A',padding:'14px 36px',textDecoration:'none'}}>Get In Touch</a>
    ...
    <footer className="ftr" style={{padding:'40px clamp(20px,4vw,80px)',borderTop:'1px solid rgba(247,247,244,0.06)',display:'flex',alignItems:'center',justifyContent:'space-between',background:'#14161B'}}>
      <div style={{display:'flex',alignItems:'center',gap:12}}>
        ...
        <div style={{fontFamily:'DM Mono,monospace',fontSize:'clamp(7px,0.65vw,9px)',letterSpacing:'0.2em',color:'rgba(247,247,244,0.3)'}}>© 2026 Umbrella Auto Exchange</div>
      </div>
